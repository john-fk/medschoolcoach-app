...
class _CourseProgressCardState extends State<CourseProgressCard>
  ...
  Widget build(BuildContext context) {
    scheduleProgressColor = scheduleProgressPercent < 0.5
                  ...
                  : Column(
                      ...
                      children: [
                        Text(
                          ...
                          " completed of our video courses",
      ...
      child: Row(
        children: [
          ...
          Flexible(
              ...
              child: RichText(
                text: TextSpan(
                  text: 'Congratulations! You have completed'.toUpperCase(),
                  style:
                      bigResponsiveFont(context, fontWeight: FontWeight.w900),
                  children: <TextSpan>[
                    TextSpan(
                        text: '\n100% of our program'.toUpperCase(),
