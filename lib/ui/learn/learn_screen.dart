  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 8,
          title: Padding(
            padding: EdgeInsets.symmetric(horizontal: whenDevice(context,
                large: 8, medium: 4, small: 4)),
            child: Text(
              "Learn",
              style:
              greatResponsiveFont(context, fontWeight: FontWeight.w700),
            ),
          ),
          centerTitle: false,
          titleSpacing: 12,
              ...
              TabBar(
                ...
                onTap: (int index) {
                  ...
                  _analyticsProvider.logEvent(
                      "switch_learn_tab", params: {"name": tabName});
                },
                tabs: [
                  Padding(
                    padding: EdgeInsets.only(bottom: 10.0,
                        right: 5, left: isTablet(context) ? 2 : 0),
                    child: Text("Schedule"),
                  ),
                  Padding(
...
class ShrinkedTabBar extends StatelessWidget with PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        tabBar, Expanded(child: Container())
      ],
    );
  }
